/* eslint-disable function-paren-newline */ /* eslint-disable prettier/prettier */ "use strict";
// write code here
const offices = [
    "Tokyo",
    "Singapore",
...
document.addEventListener("DOMContentLoaded", ()=>{
        ...
        element.addEventListener("click", ()=>{
            ...
            function sortList(list) {
                ...
                switch(headerName){
                    ...
                    case "Position":
                    case "Office":
                        sortedList = list.sort((a, b)=>sortOrder[columnNumber] ? a.cells[columnNumber].textContent.trim().localeCompare(b.cells[columnNumber].textContent.trim()) : b.cells[columnNumber].textContent.trim().localeCompare(a.cells[columnNumber].textContent.trim()));
                        break;
                    case "Salary":
                        sortedList = list.sort((a, b)=>sortOrder[columnNumber] ? parseFloat(a.cells[columnNumber].textContent.slice(1).split(",").join("")) - parseFloat(b.cells[columnNumber].textContent.slice(1).split(",").join("")) : parseFloat(b.cells[columnNumber].textContent.slice(1).split(",").join("")) - parseFloat(a.cells[columnNumber].textContent.slice(1).split(",").join("")));
                        break;
                    case "Age":
                        sortedList = list.sort((a, b)=>sortOrder[columnNumber] ? parseInt(a.cells[columnNumber].textContent) - parseInt(b.cells[columnNumber].textContent) : parseInt(b.cells[columnNumber].textContent) - parseInt(a.cells[columnNumber].textContent));
                        break;
                    default:
                        return;
                }
    ...
    table.addEventListener("dblclick", (e)=>{
        ...
        const columnName = cellForEdit.dataset.columnName || columnNames[cellForEdit.cellIndex];
        let input;
